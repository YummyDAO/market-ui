...
export default defineMessages({
  ...
  dangerousMessage:
    'The transaction may fail unless sufficient gas price is used to confirm the transaction in time. Failed transactions are also subject to a fee by the Ethereumpow network. Use the fast gas price option to reduce the likelihood of the transaction failing.',
