...
export default defineMessages({
  ...
  secondDescription:
    'Stakers receive Safety Incentives in the form of REALP tokens in exchange for taking this risk to secure the protocol. You will need to activate a {cooldownPeriod} before you are able to withdraw your stake.',
