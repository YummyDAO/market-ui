...
export const marketsData: { [key in keyof typeof CustomMarket]: MarketDataType } = {
  ...
  [CustomMarket.amm_mainnet]: {
    ...
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER: '0x992A5d60a46bCC5Df62B5AEe008A347DD4ACA7D4'.toLowerCase(),
      LENDING_POOL: '0xaae022ef7c1F702420152e9004Ad36D8dD3DF1Dc',
      WETH_GATEWAY: '0x784413137DE4D602dCe781fe40084a15005A126d',
    },
  },
